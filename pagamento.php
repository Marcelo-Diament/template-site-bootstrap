...
<main class="container-fluid">
    <header class="topo-pagina p-3 mb-5" id="topoPagamento">
        ...
        <p class="px-3 pt-0 topo">Você está quase lá! Complete o formulário a seguir e depois é só aguardar!</p>
    </header>
    <section class="container my-3">
        <form action="pagamento-confirmado.php" method="post" class="row">
                ...
                <div class="sticky-top">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="enderecoEntregaIgualDeCobranca">O endereço de entrega é o mesmo que o de cobrança</label>
                        </div>
                    </div>
                </div>
            </article>
            <article class="dados-pedido col-12 col-md-5" id="dadosPedido">
                ...
                <div class="form-group clearfix">
                    <button type="submit" class="btn btn-info float-right">Confirmar Pagamento</button>
                </div>
            </article>
        </form>
    </section>
